<div class="art-and-music-book">
	...
	<p style="text-align: justify;">
		...
		and music, you can play my games or watch my video uploads on my <a
			...
			class="base-hover"
			target="_blank"
			href="https://www.youtube.com/@wsvrez">YouTube</a
		>
		account - sometimes I add things on
		<a
			data-sveltekit-reload
			rel="external"
			class="base-hover"
			target="_blank"
			href="https://wiseshepherd.bandcamp.com">Bandcamp</a
		>.
	</p>
</div>
